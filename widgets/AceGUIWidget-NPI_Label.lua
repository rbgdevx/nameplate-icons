...
-------------------------------------------------------------------------------]]
local Type, Version = "NPI_Label", 28
...
local function UpdateImageAnchor(self)
  ...
  local npi_label = self.npi_label
  local height

  npi_label:ClearAllPoints()
  image:ClearAllPoints()

  if self.imageshown then
    local imagewidth = image:GetWidth()
    if (width - imagewidth) < 200 or (npi_label:GetText() or "") == "" then
      -- image goes on top centered when less than 200 width for the text, or if there is no text
      image:SetPoint("TOP")
      npi_label:SetPoint("TOP", image, "BOTTOM")
      npi_label:SetPoint("LEFT")
      npi_label:SetWidth(width)
      height = image:GetHeight() + npi_label:GetStringHeight()
      ...
      if image:GetHeight() > npi_label:GetStringHeight() then
        npi_label:SetPoint("LEFT", image, "RIGHT", 4, 0)
      else
        npi_label:SetPoint("TOPLEFT", image, "TOPRIGHT", 4, 0)
      end
      npi_label:SetWidth(width - imagewidth - 4)
      height = max(image:GetHeight(), npi_label:GetStringHeight())
    ...
    -- no image shown
    npi_label:SetPoint("TOPLEFT")
    npi_label:SetWidth(width)
    height = npi_label:GetStringHeight()
  end
...
local methods = {
  ...
  ["SetColor"] = function(self, r, g, b)
    ...
    self.npi_label:SetVertexColor(r, g, b)
  end,
  ...
  ["SetFont"] = function(self, font, height, flags)
    if not self.fontObject then
      self.fontObject = CreateFont("AceGUI40NPILabelFont" .. AceGUI:GetNextWidgetNum(Type))
    end
  ...
  ["SetFontObject"] = function(self, font)
    self.npi_label:SetFontObject(font or GameFontHighlightSmall)
    UpdateImageAnchor(self)
  end,
  ...
  ["SetJustifyH"] = function(self, justifyH)
    self.npi_label:SetJustifyH(justifyH)
  end,

  ["SetJustifyV"] = function(self, justifyV)
    self.npi_label:SetJustifyV(justifyV)
  end,
}
...
local function Constructor()
  ...
  local npi_label = frame:CreateFontString(nil, "BACKGROUND", "GameFontHighlightSmall")
