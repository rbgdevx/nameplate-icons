...
local methods = {
  ...
  ["CreateButton"] = function(self)
    ...
    local button =
      CreateFrame("Button", ("AceGUI40TreeButton%d"):format(num), self.treeframe, "OptionsListButtonTemplate")
    button.obj = self
...
local function Constructor()
  ...
  local scrollbar =
    CreateFrame("Slider", ("AceConfigDialog40TreeGroup%dScrollBar"):format(num), treeframe, "UIPanelScrollBarTemplate")
