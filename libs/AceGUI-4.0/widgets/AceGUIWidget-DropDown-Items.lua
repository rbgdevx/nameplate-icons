...
function ItemBase.Create(type)
  -- NOTE: Most of the following code is copied from AceGUI-4.0/Dropdown widget
  local count = AceGUI:GetNextWidgetNum(type)
  local frame = CreateFrame("Button", "AceGUI40DropDownItem" .. count)
  local self = {}
  self.frame = frame
  frame.obj = self
  self.type = type
...
local IBLib = LibStub:NewLibrary("AceGUI-4.0-DropDown-ItemBase", ItemBase.version)
if IBLib then
